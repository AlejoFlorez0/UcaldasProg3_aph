...
import {Tususuario, TususuarioRelations, Tusrol, Tususuariorol, Tadmzonasocial, Tadmzonasocialusuario, Tadmmulta, Tadmmultausuario} from '../models';
